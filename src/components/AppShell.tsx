                  ...
                  return (
                    <Link
                      ...
                      className={`inline-flex h-10 items-center rounded-xl px-4 text-sm font-semibold transition ${
                        active ? "bg-brand text-white" : "border border-border bg-white text-neutral-700"
                      }`}
                    >
                      {link.label}
                    </Link>
                ...
                return (
                  <Link
                    ...
                    className={`flex h-11 items-center rounded-xl px-4 text-sm font-semibold transition ${
                      active ? "bg-brand text-white" : "text-neutral-700 hover:bg-white"
                    }`}
                  >
                    {link.label}
                    {showBadge ? (
                ...
                return (
                  <Link
                    ...
                    className={`shrink-0 rounded-xl px-4 py-2.5 text-sm font-semibold ${
                      active ? "bg-brand text-white" : "bg-white text-neutral-700"
                    }`}
                  >
                    {link.label}
                  </Link>
